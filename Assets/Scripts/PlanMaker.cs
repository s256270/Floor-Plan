...
/* プラン作成で完成したものを表示する */
public class PlanMaker : CreateRoom
{    
    //プラン作成時の部屋を管理するリスト
    public List<GameObject> plan = new List<GameObject>();
    ...
    public void planMake2()
    {
        ...
        plan.Add(GameObject.Find("1K(29.64m^2)"));
        ...
        plan.Add(GameObject.Find("1K(30.05m^2)"));
        ...
        plan.Add(GameObject.Find("1K(28.02m^2)"));
        ...
        plan.Add(GameObject.Find("1K(28.40m^2)"));
